...
void setLEDLight()
{
  ...
  String p2tags = localStorage.getString("p1", "0");
  String p3tags = localStorage.getString("p1", "0");
  String p4tags = localStorage.getString("p1", "0");
  String p5tags = localStorage.getString("p1", "0");
  String p6tags = localStorage.getString("p1", "0");
  String p7tags = localStorage.getString("p1", "0");
  String p8tags = localStorage.getString("p1", "0");
...
void callback(char *topic, byte *payload, unsigned int length)
{
  ...
  if (String(topic) == topic_name_p)
  {
    ...
    PWM_INFO_RTC = String(localStorage.getUInt("localTime", 1572870999));

    struct timeval stime;
    stime.tv_sec = PWM_INFO_RTC.toInt() + 28800;
    ...
    localStorage.putString("version", PWM_INFO_VERSION);
    cJSON_Delete(root);
    cJSON_Delete(item);
  }
